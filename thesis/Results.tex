...
% FT-Trans. — not yet run; row will be added after FT-Transformer experiment \\
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.88\textwidth]{figures/pr_curves_ulb_baseline.pdf}
...
% TODO: Will be generated from real data once BAF experiments are complete.
% \begin{figure}[ht]
%   \centering
%   \includegraphics[width=0.88\textwidth]{figures/pr_curves_baf_baseline.pdf}
%   \caption{Precision--Recall curves for all models on BAF Base
%     (strategy\,=\,None). PR-AUC values in parentheses.}
...
at this sample size.
BAF~Base results (with dummy values) will be updated once the BAF pipeline is completed.
FT-Transformer results will likewise be added once that model is implemented.
...
\input{tables/factorial_ulb_prauc}

\input{tables/factorial_ulb_f2}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/heatmap_ulb_f2.pdf}
...
% \begin{figure}[ht]
%   \centering
%   \includegraphics[width=0.88\textwidth]{figures/baf_variants_comparison.pdf}
