...
\small
\captionof{table}[Best Optuna hyperparameters on ULB 2013]{Best hyperparameter configurations found by Optuna on ULB 2013 (strategy\,=\,None).}
...
\par\medskip\noindent\begin{minipage}{\linewidth}\centering
\small
\captionof{table}[Best Optuna hyperparameters on BAF Base]{Best hyperparameter configurations found by Optuna on BAF Base (strategy\,=\,None).}
...
\caption[Per-feature attention for three False Positive cases]{Per-feature attention weights for three False Positive cases (BAF Base). Orange bars\,=\,categorical features; blue bars\,=\,numerical features. Dashed line\,=\,uniform attention baseline ($1/31 \approx 3.2\%$). All cases have score just above $\tau = 0.058$.}
