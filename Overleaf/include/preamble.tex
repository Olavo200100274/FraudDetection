...
% Keep British English as the document default; enable Portuguese for
% language-scoped front-matter sections.
...
\usepackage{graphicx}
% Load the cover's Helvetica-compatible font without changing the
% sans-serif or bold defaults used by the rest of the dissertation.
\let\ThesisOriginalSansDefault\sfdefault
\let\ThesisOriginalBoldDefault\bfdefault
\usepackage{tgheros}
\let\sfdefault\ThesisOriginalSansDefault
\let\bfdefault\ThesisOriginalBoldDefault
\usepackage{rotating}
\usepackage{tikz}
...
\usepackage{parskip}
\usepackage{fancyhdr}	
% Suppress running headers and page numbers on blank verso pages inserted by
% \cleardoublepage in the two-sided, open-right layout.
